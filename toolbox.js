    ...
    class Rectangle {
        constructor(x = 0, y = 0, w = 0, h = 0, _c = 'black') {
            defineControlledProperty(this, 'x', x, nx => {
                if (isNaN(nx)) throw 'x proprerty accept numbers only';
            });
            defineControlledProperty(this, 'y', y, ny => {
                if (isNaN(ny)) throw 'y proprerty accept numbers only';
            });
            defineControlledProperty(this, 'h', h, nh => {
                if (isNaN(nh)) throw 'h proprerty accept numbers only';
            });
            defineControlledProperty(this, 'w', w, nw => {
                if (isNaN(nw)) throw 'w proprerty accept numbers only';
            });
            this.c = _c;
